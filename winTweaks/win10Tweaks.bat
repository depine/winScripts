...
REM DISM /Online /Get-ReservedStorageState >nul 2>&1
...
echo Ocultando Noticias e Clima (win10)...
...
REM echo Ocultando arquivos recomendados no menu iniciar, explorer e listas de atalhos:
REG ADD "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v Start_TrackDocs /t REG_DWORD /d 0 /f >nul 2>&1

REM echo Desativando recomendacoes para dicas, atalhos, novos aplicativos e muito mais
...
REM echo Desativando notificacoes relacionadas a conta...
...
:: Powershell script externo para remover Tiles do Menu Iniciar (win10)
